...
app.get("/getschedule_oceb",  (req, res) => {
...
app.get("/getschedule_ocwb",  (req, res) => {
...
app.get("/getschedule_rcwb1",  (req, res) => {
...
app.get("/getschedule_rcwb2",  (req, res) => {
...
app.get("/getschedule_rceb1",  (req, res) => {
...
app.get("/getschedule_rceb2",  (req, res) => {
